...
bd = pd.read_csv('../interim/population/IBGE_births-deaths_uf.csv')
...
# format output
output = pop[['CD_MUN', 'year', 'population', 'estimated_births', 'estimated_deaths']].to_csv('../interim/population/pop-births-deaths_mun_2001-2024.csv', index=False)
