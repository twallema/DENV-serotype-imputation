...
+ `births_mun_1998-2026.csv`: Made from `~/data/raw/demographics/births_2000-2024_clean.csv` using `build_births-deaths.py`.

+ `deaths_mun_1998-2026.csv`: Made from `~/data/raw/demographics/deaths_2000-2024_clean.csv` using `build_births-deaths.py`.
